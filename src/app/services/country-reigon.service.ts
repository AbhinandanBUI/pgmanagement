...
export class CountryRegionService {
  ...
  getStateListByCountryCode(countryCode: string) {
    let url = environment.baseApiUrl + 'api/state/getStatesByCountryCode';
    let queryParams = new HttpParams();
    queryParams = queryParams.append("countryId", countryCode);
